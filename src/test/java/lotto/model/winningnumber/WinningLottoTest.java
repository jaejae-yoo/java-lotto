...
class WinningLottoTest {
    ...
    void validateInputLottoNumberBlank(String numbers) {
        assertThatThrownBy(() -> new WinningLotto(List.of(numbers), "7"))
    ...
    void validateInputLottoWinningNumberSize(String numbers) {
        assertThatThrownBy(() -> new WinningLotto(List.of(numbers.split(",")), "7"))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void validateReduplicationWithBonusBall(String number) {
        WinningLotto winningNumber = new WinningLotto(List.of("1,2,3,4,5,6".split(",")), "7");
    ...
    void validateBonusBallBlank(String number) {
        assertThatThrownBy(() -> {
            ...
            new WinningLotto(List.of("1", "2", "3", "4", "5", "7"), number);
    ...
    void validateBonusBallNumber(String number) {
        assertThatThrownBy(() -> new WinningLotto(List.of("1", "2", "3", "4", "5", "7"), number))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void saveBonusBallNumber() {
        WinningLotto winningLotto = new WinningLotto(List.of("1", "2", "3", "4", "5", "7"), "7");
        assertThat(winningLotto.getBonusBall()).isEqualTo(7);
    }
}
